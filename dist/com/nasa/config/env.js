...
exports.ENV = {
    ...
    ACCOUNT_DAILY_POST_LIMIT: num("ACCOUNT_DAILY_POST_LIMIT", 2),
    ...
    INTERACTION_MAX_COMMENTS_PER_RUN: num("INTERACTION_MAX_COMMENTS_PER_RUN", 2),
    ...
    POST_START_JITTER_MS: num("POST_START_JITTER_MS", 15000),
    SURF_START_JITTER_MS: num("SURF_START_JITTER_MS", 10000),
